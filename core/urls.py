...
urlpatterns = [
    ...
    path('<int:baby_pk>/edit_baby/', views.EditBaby.as_view(), name='edit_baby'),
    ...
    path('<int:baby_pk>/records/<int:record_pk>/edit_record/', views.EditRecord.as_view(), name='edit_record'),
]
